...
writeFileSync(
  ...
  [
    ...
    "      源码安装目录为 dsh-src-<版本>，预构建内核目录为 dsh-<版本>。",
    "",
    "======================================================",
    ...
    "  · Choose whether to keep the current version when updating (by default, selected old versions are removed after upgrade)",
    ...
    "      The source install directory is dsh-src-<version>; the prebuilt kernel directory is dsh-<version>.",
    "",
  ].join("\r\n"),
);
